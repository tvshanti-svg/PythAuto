...
st.title("A1 vs A2 Excel Checker")
...
if st.button("Process"):
    if not a1_file or not a2_file:
        ...
        # Convert A columns to string
        a1['A'] = a1['A'].astype(str).str.strip()
        a2['A'] = a2['A'].astype(str).str.strip()

        # Convert a2 B column to date
        a2['B'] = pd.to_datetime(a2['B'], errors='coerce')
